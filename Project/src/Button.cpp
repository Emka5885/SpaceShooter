...
Button::Button(sf::Vector2f size, sf::Text text, sf::Vector2f position, float zoom, sf::Color outlineColor, sf::Color color) : unhoveredSize(size), text(text), unhoveredPosition(position), zoom(zoom)
{
